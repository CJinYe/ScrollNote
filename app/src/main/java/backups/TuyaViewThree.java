...
public class TuyaViewThree extends View {
    ...
    public TuyaViewThree(Context context, Bitmap bitmapc, int w, int h) {
        super(context);
    ...
    public TuyaViewThree(Context context, AttributeSet attributeSet) {
    ...
    public TuyaViewThree(Context context, int w, int h) {
        super(context);
        this.context = context;
        screenWidth = w;
        screenHeight = h;
    ...
    public String saveToSDCard(String time, String content) {
        ...
        for (int i = 0; i < savePath.size(); i++) {
            ...
            mSaveCanvas.drawBitmap(mSaveBitmap, 0, 0, null);
        }
