...
public class TapBarMenu extends LinearLayout {
    ...
    private void setupAttributes(AttributeSet attrs) {
        ...
        backgroundColor = typedArray.getColor(R.styleable.TapBarMenu_tbm_backgroundColor, getContext().getResources().getColor(R.color.red));
        buttonSize =
    ...
    public void setMenuBackgroundColor(int colorResId) {
        backgroundColor = getContext().getResources().getColor(colorResId);
        paint.setColor(backgroundColor);
        invalidate();
    }
...
//                    Log.d("MotionEvent", "dianji");
//                } else {
//                    onClickListener.onClick(this);
//                    Log.d("MotionEvent", "点击");
//                }
//            }
//        }
//        return true;
